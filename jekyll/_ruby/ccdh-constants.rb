module CCDH
  ...
  V_M_DISPLAY = "#{H_NAME}, #{H_TITLE}, #{H_SUMMARY}, #{H_DESCRIPTION}, #{H_GH_ISSUE}, #{H_STATUS}, #{H_NOTES}, #{H_BUILD}"
  V_P_DISPLAY = "#{H_NAME}, #{H_TITLE}, #{H_SUMMARY}, #{H_DESCRIPTION}, #{H_GH_ISSUE}, #{H_STATUS}, #{H_NOTES}, #{H_BUILD}"
  V_C_DISPLAY = "#{H_PACKAGE}, #{H_TITLE}, #{H_NAME}, #{H_SUMMARY}, #{H_DESCRIPTION}, #{H_GH_ISSUE}, #{H_STATUS}, #{H_NOTES}, #{H_BUILD}"
  V_E_DISPLAY = "#{H_PACKAGE}, #{H_TITLE}, #{H_NAME}, #{H_SUMMARY}, #{H_DESCRIPTION}, #{H_GH_ISSUE}, #{H_STATUS}, #{H_NOTES}, #{H_BUILD}"
  V_S_DISPLAY = "#{H_PACKAGE}, #{H_TITLE}, #{H_NAME}, #{H_SUMMARY}, #{H_DESCRIPTION}, #{H_GH_ISSUE}, #{H_STATUS}, #{H_NOTES}, #{H_BUILD}"
