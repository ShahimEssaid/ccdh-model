module CCDH
  ...
  V_PACKAGE_DEFAULT_ROW = [V_PKG_BASE, "Package #{V_PKG_BASE} summary.", "Package #{V_PKG_BASE} description.", "", V_STATUS_CURRENT, "", "", ""]

  V_CONCEPT_HEADERS = [H_PACKAGE, H_NAME, H_SUMMARY, H_DESCRIPTION, H_GH_ISSUE, H_PARENTS, H_RELATED, H_STATUS, H_NOTES, H_BUILD]
  V_CONCEPT_THING_ROW = ["#{V_PKG_BASE}", V_CONCEPT_THING, 'Thing summary.', 'Thing description.', '', '', '', V_STATUS_CURRENT, '', '']
  V_CONCEPT_ENTITY_ROW = ["#{V_PKG_BASE}", V_CONCEPT_ENTITY, 'Entity summary.', 'Entity description.', '', V_THING_C_BASE, '', V_STATUS_CURRENT, '', '']
  V_CONCEPT_PRIMITIVE_ROW = ["#{V_PKG_BASE}", V_CONCEPT_PRIMITIVE, 'Primitive summary.', 'Primitive description.', '', V_THING_C_BASE, '', V_STATUS_CURRENT, '', '']
  V_CONCEPT_TAG_ROW = ["#{V_PKG_BASE}", V_CONCEPT_TAG, 'Tag summary.', 'Tag description.', '', V_THING_C_BASE, '', V_STATUS_CURRENT, '', '']
  ...
  V_ELEMENT_HAS_ENTITY_ROW = ["#{V_PKG_BASE}", V_ELEMENT_HAS_ENTITY, "#{V_ELEMENT_HAS_ENTITY} summary", "#{V_ELEMENT_HAS_ENTITY} description", '', '', V_ENTITY_C_BASE, V_ENTITY_C_BASE, V_ENTITY_C_BASE, '', V_STATUS_CURRENT, '', '']
  #V_ELEMENT_HAS_VALUE_ROW = ["#{V_PKG_BASE}", V_ELEMENT_HAS_VALUE, "#{V_ELEMENT_HAS_VALUE} summary", "#{V_ELEMENT_HAS_VALUE} description", '', '', V_E_C_BASE, V_THING_C_BASE, V_THING_C_BASE, '', V_STATUS_CURRENT, '', '']
